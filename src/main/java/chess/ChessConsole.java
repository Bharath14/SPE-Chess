...
import chess.game_.GameInfo;
import chess.game_.GameStatus;
import chess.players.Ai;
import chess.players.Human;
import chess.players.Player;
import chess.players.PlayerFactory;
...
public class ChessConsole {
            ...
            if (x1 >= 0 && x1 < 8 && y1 >= 0 && y1 < 8) {
                ...
                if (player.setSource(source, game)) {
                    ...
                    if (x2 >= 0 && x2 < 8 && y2 >= 0 && y2 < 8) {
                        ...
                        player.setDest(dest);
                        result = player.move(game, pieceType);
                    } else {
    ...
    public static void moveai(Game game)
    {
        Player player = game.getCurrentTurn();
        String pieceType="";
        boolean result = player.move(game,pieceType);
    }
