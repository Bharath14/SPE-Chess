...
import static chess.game_.GameStatus.*;
    ...
    public void start(Stage primaryStage) {
        ...
        board.setOnMouseReleased(new EventHandler <MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                ...
                if (player.getColor()== chess.Color.WHITE) {
        ...
        quit.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                chess.Color currColor= curr.getColor();
                if(currColor== chess.Color.WHITE) {
    ...
    public void drawBoard(GridPane b) {
        ...
        for (int i = 7; i >= 0; i--) {
            for (int j = 7; j >= 0; j--) {
                ...
                chess.Color pieceColor = currentPiece.getColor();
                ...
                switch (currentPiece.getType()) {
                    case KING:
                        //System.out.println("x");
                        picture = (pieceColor== chess.Color.WHITE) ? "WhiteKing.png" : "BlackKing.png";
                        //System.out.println(base+picture);
                        break;
                    case QUEEN:
                        picture = (pieceColor== chess.Color.WHITE) ? "WhiteQueen.png" : "BlackQueen.png";
                        break;
                    case ROOK:
                        picture = (pieceColor== chess.Color.WHITE) ? "WhiteRook.png" : "BlackRook.png";
                        break;
                    case BISHOP:
                        picture = (pieceColor== chess.Color.WHITE) ? "WhiteBishop.png" : "BlackBishop.png";
                        break;
                    case KNIGHT:
                        picture = (pieceColor== chess.Color.WHITE) ? "WhiteKnight.png" : "BlackKnight.png";
                        break;
                    case PAWN:
                        picture = (pieceColor== chess.Color.WHITE) ? "WhitePawn.png" : "BlackPawn.png";
                        break;
                    default:
                        //System.out.println("x");
                        picture = null;
...
*/
    ...
    public Scene drawStartingPage(Stage primaryStage, Scene s){
        ...
        hVSh.setOnAction(new EventHandler<ActionEvent>(){
            @Override
            public void handle(ActionEvent event){
                playerWhite = new Human(chess.Color.WHITE);
                playerBlack = new Human(chess.Color.BLACK);
                game = new Game(playerWhite,playerBlack);
        ...
        hVSm.setOnAction(new EventHandler<ActionEvent>(){
            ...
            public void handle(ActionEvent event){
                ...
                playerWhite = new Human(chess.Color.WHITE);
                playerBlack = new AlphaBeta(chess.Color.BLACK);
                game = new Game(playerWhite,playerBlack);
                primaryStage.setScene(mainScene);
            }
        });
        mVSr.setOnAction(new EventHandler<ActionEvent>(){
            ...
            public void handle(ActionEvent event){
                playerWhite = new Human(chess.Color.WHITE);
                playerBlack = new Minimax(chess.Color.BLACK);
                game = new Game(playerWhite,playerBlack);
                primaryStage.setScene(mainScene);
            }
        });
